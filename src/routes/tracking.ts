...
import { syncLimitOrders } from "../controllers/tracking/sushiswapLimitOrder";
import {
  placeLimitOrder,
...
import { createPerpPosition } from "../controllers/tracking/perpPositionTracking";
...
router.patch(
  "/bot/execution/:id/wallet/:wallet_index/start",
  startWalletExecution,
);
router.patch(
  "/bot/execution/:id/wallet/:wallet_index/complete",
  completeWalletExecution,
);
...
// perps position
router.post("/perp-position", createPerpPosition);
